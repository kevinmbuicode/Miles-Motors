...
console.log(images);
  ...
  return (
    ...
    <div className="container">
      <button onClick={() => carousel.current.slickGoTo(0)} className="button">Go to first</button>
      <button onClick={() => carousel.current.slickGoTo(images.length - 1)}className="button">
        Go to last
      </button>
